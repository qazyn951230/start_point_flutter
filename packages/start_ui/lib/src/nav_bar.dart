...
///
/// When used in a [UIPage], [UIPage.navigationBar]
...
/// See also:
///
///  * [UIPage], a page layout helper typically hosting the
///    [UINavigationBar].
///  * [SliverNavigationBar] for a navigation bar to be placed in a
///    scrolling list and that supports iOS-11-style large titles.
class NavigationBar extends StatefulWidget implements ObstructingWidget {
      ...
      builder: (BuildContext context) {
        return Hero(
          ...
          child: _TransitionableNavigationBar(
            componentsKeys: keys,
            backgroundColor: backgroundColor,
            backButtonTextStyle: theme.style,
    ...
    return MediaQuery(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _LargeTitleNavigationBarSliverDelegate(
          ...
          border: widget.border,
          padding: widget.padding,
          actionsForegroundColor: theme.color,
...
class _LargeTitleNavigationBarSliverDelegate
  ...
  Widget build(
    ...
    return Hero(
      ...
      // CupertinoSliverNavigationBar like UINavigationBar because it
      ...
      child: _TransitionableNavigationBar(
        ...
        backButtonTextStyle: theme.style,
        titleTextStyle: theme.titleStyle,
        largeTitleTextStyle: theme.largeTitleStyle,
        border: border,
  ...
  Widget build(BuildContext context) {
    ...
    if (middle != null) {
      middle = DefaultTextStyle(
        style: NavigationBarTheme.of(context).titleStyle,
...
// components that are used in common by the UINavigationBar and
...
class _NavigationBarStaticComponents {
  ...
  static Widget _derivedTitle({
    ...
    // Auto use the UIPageRoute's title if middle not provided.
    if (automaticallyImplyTitle &&
        currentRoute is UIPageRoute &&
  ...
  Widget build(BuildContext context) {
    ...
    if (onPressed == null) {
      assert(
        ...
        'UINavigationBarBackButton should only be used in routes that can be popped',
      );
    }

    TextStyle actionTextStyle = NavigationBarTheme.of(context).style;
    if (color != null) {
